        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StyleNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Title = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Year = table.Column<int>(type: "INTEGER", nullable: false),
                    Season = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Progress = table.Column<int>(type: "INTEGER", nullable: false),
                    FabricInformation = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModificationNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModificationNotes_ClothingItems_ClothingItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClothingItems_StyleNumber",
                table: "ClothingItems",
                column: "StyleNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ModificationNotes_ClothingItemId",
                table: "ModificationNotes",
